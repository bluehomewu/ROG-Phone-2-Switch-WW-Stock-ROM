...
ui_print " ********* ROG Phone 2 Switch WW In Stock ROM $VERSIONID *********"
ui_print " Build date  : $BUILDDATEID"
ui_print " Author      : $AUTHORID"
ui_print " Telegram    : $TELEGRAMID"
ui_print " *************************************"
ui_print " 本模組僅適用於騰訊菁英版ROG Phone 2"
ui_print " This Magiak Module only applicable to Tencent ROG Phone 2"
ui_print " *************************************"
ui_print " "
ui_print " ******************"
